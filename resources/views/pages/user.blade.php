                ...
                @if($data)
                    ...
                    @foreach($data as $user)
                        <tr>
                            ...
                            <td>{{ $user->role }}</td>
                            <td>
                                <span class="badge {{ $user->is_active ? 'bg-label-primary' : 'bg-label-danger' }} me-1">
                ...
                <div class="modal-body">
                    ...
                    <div class="role" :label="__('ROLE')">
                        ...
                        <select id="role" name="role" class="form-select"> <!-- Tambahkan atribut name -->
                            ...
                            <option value="kasubagumumgudang">Kasubag Umum dan Gudang</option>
                        </select>
                    </div>
                </div>
        ...
        <form class="modal-content" method="post" action="">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" id="password" class="form-control" placeholder="{{ __('Masukan Password Baru disini') }}">
                    <small class="form-text text-muted">{{ __('Maukan Password Baru Disini') }}</small>
                </div>
                <br> 

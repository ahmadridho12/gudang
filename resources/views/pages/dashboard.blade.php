...
<script src="{{ asset('sneat/vendor/libs/apex-charts/apexcharts.js') }}"></script>
    ...
    <script>
        const options = {
            ...
            colors: [ // Tambahkan properti colors
            ...
            series: [{
                ...
                data: [{{ $todayDetailBarangMasuk}},{{ $todayDetailBarangKeluar }},{{ $todaypermintaan }}]
            }],
            stroke: {
                curve: 'smooth',
            },
                        ...
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3"
                            ...
                            <div class="">
                                ...
                                <div class="mt-sm-auto">
                                    <div>
                                        <h5>Barang Masuk</h5>
                                        <h3 class="mb-0 display-4">{{ $todayDetailBarangMasuk }}</h3>
                                    ...
                                    <div>
                                        <h5>Barang Keluar</h5>
                                        <h3 class="mb-0 display-4">{{ $todayDetailBarangKeluar }}</h3>
                                    ...
                                    <div>
                                        <h5>Permintaan</h5>
                                        <h3 class="mb-0 display-4">{{ $todaypermintaan }}</h3>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <x-dashboard-card-simple
                        :label="__('Total Barang Keluar')"
                        :value="$todayDetailBarangKeluar"
                        :daily="true"
                        color="primary"
                        icon="bx bx-log-out"
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <x-dashboard-card-simple
                        :label="__('Total Barang Masuk')"
                        :value="$todayDetailbarangmasuk"
                        :daily="true"
                        color="warning"
                        icon="bx bx-log-in"
                        :percentage="$percentageIncomingLetter"
